...
client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/d214146db99a0f9a92ae6.jpg' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: 'https://wa.me/254740782927?text=ʜᴇʟʟᴏ+𝗠𝗶𝗸𝗲+Nihostie+Bot+Mkuu+🥲',
                                mediaType: 1,
...
case "speed": 
              ...
              client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/ff69b8b9954118c03e727.jpg' }, caption:`𝗞𝗥𝗔𝗧𝗢𝗦 𝗩𝟵\n\n𝐒𝐏𝐄𝐄𝐃:𝓟𝓸𝓷𝓰...! ${dreadedspeed.toFixed(4)} 𝓶𝓼`}); 
 break; 
...
case "ping": case "speed": { 
 ...
 case "runtime": { 
                 m.reply (`𝗞𝗥𝗔𝗧𝗢𝗦 𝗩𝟵 has been running for ${runtime(process.uptime())}`) 
 } 
 break;

case "alive": { 
  
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2312ce7ea61fe62501f7.jpg' }, caption: `Hello ${m.pushName}, 𝗞𝗥𝗔𝗧𝗢𝗦 is alive since  ${runtime(process.uptime())}`, fileLength: "9999999999898989899999999" }, { quoted: m }); 
 }
break;
case 'apk': {
...
client.sendMessage(from, buttonMessage, { quoted: m }) 
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `Converted by 𝗞𝗥𝗔𝗧𝗢𝗦! `}, { quoted: m }) 
...
case "movie": 
 ...
 break;
          ...
          case "kratos": case "owner": case "mike": 
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/1d8d1a5836eeeb2c20dc8.jpg' }, caption: `Say no more 😌 here is Mike contact +254740782927 🥱` }, {quoted: m}); 
  
 break; 
        
       case "script": case "repo": case "sc": 
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/10035541e70297fa72f14.jpg' }, caption: `You can deploy this bot using the github link below!\nFork and enjoy our kenyan bot✨.\n\nhttps://github.com/owlai01/Owl-Ai\n\nget your pair code on replit using this link[https://replit.com/@vagaabond9/Pairing-Owl-ai?v=1]\n\nenjoy and have fun 😊 with our bot\n\nMade on Earth by Malibu!` }, {quoted: m}); 
    ...
    break;
         ...
         for (let i of res) { 
             ...
             await client.sendMessage(i, { 
                 image: { 
                     url: "https://telegra.ph/file/10035541e70297fa72f14.jpg" 
                 }, 
                 caption: `${txt}` 
             }) 
         } 
